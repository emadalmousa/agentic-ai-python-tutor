...
export default function CodeEditor({ code, onChange, dark }: Props) {
  ...
  return (
    <div className={`rounded-xl overflow-hidden border text-sm ${dark ? "border-[#2d3f55] bg-[#0d1b2a]" : "border-gray-200 bg-gray-50"}`}>
      {highlight ? (
        <Editor
          value={code}
        ...
        <textarea
          ...
          className={`w-full p-4 font-mono text-sm focus:outline-none resize-none ${dark ? "bg-[#0d1b2a] text-gray-200" : "bg-gray-50 text-gray-800"}`}
          rows={8}
