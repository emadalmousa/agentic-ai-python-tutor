...
export default function ChatPanel({
  history, input, loading, error, bottomRef, onInput, onSend, onReset, dark
}: Props) {
  ...
  const inputBg  = dark ? "bg-[#0d1b2a] border-[#2d3f55] text-gray-200 placeholder-gray-500" : "bg-white border-gray-200 text-gray-800 placeholder-gray-400"
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-3">
        {history.length === 0 && !loading && (
          <div className={`text-center mt-12 ${subCol} text-sm`}>
            ...
            <p className="text-xs">Stell eine Frage zu deinem Code links.</p>
          </div>
        )}
        ...
        {loading && (
          <div className="flex justify-start">
            ...
            <div className={`${msgBg} px-4 py-3 rounded-2xl rounded-bl-sm`}>
