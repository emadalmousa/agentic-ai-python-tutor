  ...
  const cards: Card[] = [
    {
      ...
      icon:        <TutorIcon />,
      title:       "KI Tutor",
      description: "Stelle Fragen, lass Code erklären und bekomme sofortige Hilfe von deinem persönlichen Python-Assistenten.",
      cta:         "Tutor öffnen",
    ...
    },
    {
      ...
      description: "Sieh welche Python-Themen du beherrschst, erkenne deine Schwächen und verfolge deine Lernreise.",
